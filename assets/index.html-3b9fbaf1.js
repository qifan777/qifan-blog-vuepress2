...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
    ...
    <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2);function B(N,S){const e=p("center"),o=p("ExternalLinkIcon");return c(),d("div",null,[h,x,a(e,null,{default:t(()=>[s("图1 VuePress效果图")]),_:1}),_,a(e,null,{default:t(()=>[s("图2 首页配置介绍")]),_:1}),n("p",null,[s("在了解了基本的配置元素后，"),n("a",f,[s("我们在docs下新建README.md"),a(o)]),s("。这个页面就当作我们的首页了，我们在这个页面下输入以下配置。")]),y,a(e,null,{default:t(()=>[j,w]),_:1}),E,a(e,null,{default:t(()=>[q,D]),_:1}),s(" 可以看见第八期和第九期被合并了。 "),P,V,a(e,null,{default:t(()=>[M,T]),_:1}),C,a(e,null,{default:t(()=>[A,I]),_:1}),s(" 要实现下拉菜单中分组，需要再嵌套一层菜单配置。 "),R])}const H=l(g,[["render",B],["__file","index.html.vue"]]);export{H as default};
